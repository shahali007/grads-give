            ...
            icon: (
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_1107_605)">
                        <path
                            d="M20 26.6668C23.6819 26.6668 26.6667 23.6821 26.6667 20.0002C26.6667 16.3183 23.6819 13.3335 20 13.3335C16.3181 13.3335 13.3333 16.3183 13.3333 20.0002C13.3333 23.6821 16.3181 26.6668 20 26.6668Z"
                            stroke="#6F4025"
            ...
            icon: (
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_1107_621)">
                        <path
                            d="M35 23.3333L30 18.3333H18.3334C17.8913 18.3333 17.4674 18.1577 17.1548 17.8452C16.8423 17.5326 16.6667 17.1087 16.6667 16.6667V6.66667C16.6667 6.22464 16.8423 5.80072 17.1548 5.48816C17.4674 5.17559 17.8913 5 18.3334 5H33.3334C33.7754 5 34.1993 5.17559 34.5119 5.48816C34.8244 5.80072 35 6.22464 35 6.66667V23.3333Z"
                            stroke="#6F4025"
                            stroke-width="3.33333"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        />
                        <path
                            d="M23.3333 24.9998V28.3332C23.3333 28.7752 23.1577 29.1991 22.8452 29.5117C22.5326 29.8242 22.1087 29.9998 21.6667 29.9998H10L5 34.9998V18.3332C5 17.8911 5.17559 17.4672 5.48816 17.1547C5.80072 16.8421 6.22464 16.6665 6.66667 16.6665H10"
                            stroke="#6F4025"
                            stroke-width="3.33333"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        ...
                        <div className="mt-12 grid grid-cols-1 gap-4 justify-items-center md:grid-cols-2 lg:flex lg:justify-between">
                            {contactUsOptions.map((option, index) => (
                                <div key={index} className="w-full lg:w-100 min-h-76 px-12 py-10 flex flex-col items-center contact-us rounded-2xl">
                                    <div className="w-20 h-20 flex justify-center items-center rounded-2xl contact-us-icon">{option.icon}</div>
